...
@section('title', 'Daftar Customer - POS Fashion')
    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 text-sm mt-2">Bergabung dan nikmati kemudahan belanja!</p>
            </div>
            ...
            <form method="POST" action="{{ route('customer.register.post') }}">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-start">
                        <input type="checkbox" name="terms" required class="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500 mt-1">
                        <span class="ml-2 text-sm text-gray-600">
                            Saya menyetujui <a href="#" class="text-purple-600 hover:text-purple-700">Syarat & Ketentuan</a>
                        </span>
                    </div>
            ...
            <p class="text-center text-gray-600 text-sm mt-6">
                Sudah punya akun?
                <a href="{{ route('customer.login') }}" class="text-purple-600 hover:text-purple-700 font-medium">
                    Masuk di sini
                </a>
            </p>
        </div>
